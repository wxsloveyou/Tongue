<template>
  <div class="media">
      ...
      <el-col :span="24">
        <el-card class="box-card">
          <el-row :gutter="10">
            ...
            <el-col :span="2">
              <el-button v-if="pagePath == '/person/staff'" class="main-button" type="text">新建员工</el-button>
              <el-button v-else class="main-button" type="text">新建部门</el-button>
            </el-col>
            <el-col :span="2">
    ...
    <el-collapse-transition>
      <div v-show="show">
        <el-row :gutter="10" class="media-el-col" v-if="pagePath == '/person/staff'">
          <el-col :span="4">
